...
<div class="title-container">
    ...
    <h1 class="title" style="margin-bottom: 15px;">Cuerpo Humano</h1> <!-- Añadido el margen inferior de 20px -->
    <div class="botones-container" style="margin-bottom: 350px;">
        <a href="CHLV1.php" class="boton" style="background-image: url('Recursos/Level1.svg')"></a> <!-- Ajusta el enlace a SVLV1.php -->
        <a href="CHLV2.php" class="boton" style="background-image: url('Recursos/Level2.svg')"></a>
    </div>
