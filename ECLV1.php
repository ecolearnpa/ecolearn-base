...
<link rel="icon" href="Recursos/Logo.ico" type="image/x-icon">
    <meta charset="UTF-8">
    <title>Juego Educativo - Conoce el Ecosistema</title>
    <style>
        .title-container {
      position: absolute;
      top: -20px;
...
<div class="title-container">
    ...
    <h1 class="title">Juego Educativo - Conoce el Ecosistema</h1>
    ...
    <div class="juego-container">
        ...
        $preguntas = array(
            array(
                "pregunta" => "1. ¿Dónde viven los animales y las plantas?",
                "opciones" => array("A) Casa", "B) Parque", "C) Naturaleza"),
                "respuestaCorrecta" => "C",
                "imagen" => "Recursos/naturaleza.jpg"
            ),
            array(
                "pregunta" => "2. ¿Qué hacen las plantas para crecer?",
                "opciones" => array("A) Comer", "B) Dormir", "C) Fotosíntesis"),
                "respuestaCorrecta" => "C",
                "imagen" => "Recursos/fotosintesis.jpg"
            ),
            array(
                "pregunta" => "3. ¿De qué están hechos los árboles?",
                "opciones" => array("A) Plástico", "B) Madera", "C) Metal"),
                "respuestaCorrecta" => "B",
                "imagen" => "Recursos/arbol.jpg"
            )
        );
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($preguntaActual < $totalPreguntas - 1) {
                ...
                echo "<button class='btn btn-success' onclick=\"location.href='HomeEC.php'\">Regresar a Home</button>";
    ...
    <a href="HomeEC.php" class="atras-boton"></a>
