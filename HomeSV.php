    ...
    <style>
      ...
      padding: 15px;
        ...
        .title {
            ...
            font-weight: bold;
            text-align: center;
            margin-bottom: 15px; /* Modifica el margen inferior a 15px */
        ...
        .botones-container {
            display: flex;
            justify-content: center;
            margin-bottom: 350px; /* Modifica el margen inferior a 350px */
        }
...
<div class="title-container">
    ...
    <h1 class="title" style="margin-bottom: 15px;">Seres Vivos</h1>
    <div class="botones-container" style="margin-bottom: 350px;">
        <a href="SVLV1.php" class="boton" style="background-image: url('Recursos/Level1.svg')"></a> <!-- Ajusta el enlace a SVLV1.php -->
        <a href="SVLV2.php" class="boton" style="background-image: url('Recursos/Level2.svg')"></a>
    </div>
