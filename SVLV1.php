...
<link rel="icon" href="Recursos/Logo.ico" type="image/x-icon">
    <meta charset="UTF-8">
    <title>Juego Educativo - Identificar Animales Terrestres</title>
    <style>
        .title-container {
      position: absolute;
      top: -20px;
...
<div class="title-container">
    ...
    <h1 class="title">Juego Educativo - Identificar Animales Terrestres</h1>
    ...
    <div class="juego-container">
        ...
        $preguntas = array(
            array(
                "pregunta" => "1. ¿Qué animal terrestre tiene rayas negras y blancas?",
                "opciones" => array("A) Tigre", "B) Ballena", "C) Águila"),
                "respuestaCorrecta" => "A",
                "imagen" => "Recursos/tigre.jpg"
            ),
            array(
                "pregunta" => "2. ¿Qué animal terrestre tiene un caparazón duro?",
                "opciones" => array("A) León", "B) Tortuga", "C) Serpiente"),
                "respuestaCorrecta" => "B",
                "imagen" => "Recursos/tortuga.jpg"
            ),
            array(
                "pregunta" => "3. ¿Qué animal terrestre tiene manchas y es conocido por su velocidad?",
                "opciones" => array("A) Cebra", "B) Delfín", "C) Murciélago"),
                "respuestaCorrecta" => "A",
                "imagen" => "Recursos/cebra.jpg"
            )
        );
